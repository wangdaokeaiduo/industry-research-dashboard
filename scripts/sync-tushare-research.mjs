...
const profiles = {
  ...
  'power-sector': { keywords:['电力','发电','火电','水电','核电','风电','光伏运营','长江电力','华能国际','中国核电','三峡能源','国投电力'], consensus:'电力需求稳健增长，但供给扩张更快、不同电源收益驱动分化', conclusion:'电力长期配置价值来自稀缺资源、稳定现金流、分红和调节能力；需验证用电量、利用小时、电价、燃料/来水、自由现金流和板块量价。' },
  '300937-stock': { keywords:['药易购','300937','四川合纵药易购'], consensus:'个股不使用行业研报共识替代公司判断', conclusion:'先核验保留意见、会计差错、专项鉴证和监管风险，再判断盈利、现金流、估值与个股量价；治理风险未闭环前不介入。' }
}
